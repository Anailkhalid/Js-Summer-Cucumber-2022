...
class Homepage {
    ...
    clickOnRewards = '//a[text()="Learn about Hotels.com Rewards"]';

    JoinButton = '//a[text()="Join Now"]';

    commands = new Commands;


    async join(){
        await this.commands.clickWebElement(this.JoinButton);
        await browser.pause(2000);
    }
   

    async rewards(){
        await this.commands.clickWebElement(this.clickOnRewards);
        await browser.pause(2000);
    }
